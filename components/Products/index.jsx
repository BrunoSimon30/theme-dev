    ...
    <div className="container mx-auto">
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-4 gap-6">
          ...
          <div className="relative group">
            <div className="relative aspect-[3/4] overflow-hidden bg-gray-100 mb-4 rounded-lg cursor-pointer">
              <Link href="/products/8" className="block w-full h-full">
                <img
                  src="/img/product/p8.webp"
                  alt="Product 8"
                  className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
                />
              </Link>
            ...
            <div className="text-center">
              <Link href="/products/8">
                <h3 className="text-lg font-medium text-gray-900 mb-1 hover:text-gray-600 transition-colors">Product Name 8</h3>
              </Link>
              <p className="text-gray-700 font-medium">Rs. 8,000.00</p>
            </div>
          </div>
